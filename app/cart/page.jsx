...
export default function page() {
  ...
  const amountToPay = () => {
    const totalValueProducts = data.reduce(
      ...
      {dataLength > 0 ? (
        <>
          ...
          <div className='w-full flex  items-center justify-between mt-4 px-8'>
            ...
            <div className='mr-4'>
              <button
                className=' text-black text-xl bg-emerald-300 hover:bg-emerald-400 py-2 px-4 mx-auto my-4 rounded-lg shadow-lg transition'
                onClick={() => payByCard()}
              >
               I pay by card
              </button>
        ...
        <div className='flex flex-col items-center mt-4'>
          ...
          <Link
            href={'/'}
            className='text-black text-xl bg-emerald-300 hover:bg-emerald-500 py-2 px-4 mx-auto my-4 rounded-lg shadow-lg transition'
          >
            Back to the store
          </Link>
        </div>
